      ...
      <div className="flex h-full min-h-0 min-w-0 flex-col gap-3 overflow-x-hidden overflow-hidden">
        <div className="flex shrink-0 flex-col gap-2 sm:flex-row sm:items-start sm:justify-between min-w-0">
          <div className="min-w-0">
            ...
            <h1 className="text-lg sm:text-xl font-semibold tracking-tight text-slate-900">Withdraw funds</h1>
            <p className="text-xs text-slate-500">Transfer to a verified company account</p>
          </div>
        </div>

        <div className="min-h-0 flex-1 overflow-y-auto overflow-x-hidden min-w-0">
          <div className="mx-auto flex w-full max-w-xl flex-col gap-3 pb-2 min-w-0">
            <div className="rounded-xl border border-slate-200 bg-slate-50/40 px-2.5 py-2.5 sm:px-4 sm:py-3">
              <div className="mb-1.5 flex items-center justify-between gap-2">
                <p className="text-[10px] font-semibold uppercase tracking-wide text-slate-400">Available balance</p>
                <Wallet className="h-3.5 w-3.5 text-slate-400" />
              </div>
              <p className="text-xl sm:text-2xl font-semibold tabular-nums tracking-tight text-slate-900 truncate">{fmt(balance)}</p>
            ...
            <form onSubmit={handleWithdraw} className="rounded-xl border border-slate-200 bg-white">
              <div className="border-b border-slate-100 px-2.5 py-2.5 sm:px-4 sm:py-3">
                        ...
                        <div className="mt-2 rounded-lg border border-slate-100 bg-slate-50 p-3">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                            <div className="min-w-0">
                              ...
                              <p className="font-medium text-slate-700 truncate">{selectedAccount.bank_name}</p>
                            </div>
                            <div className="min-w-0">
                              <p className="text-[10px] font-semibold uppercase tracking-wide text-slate-400">Account</p>
                              <p className="font-mono font-medium text-slate-700 truncate">{selectedAccount.account_number}</p>
                            </div>
